...
void Histogram::extractForegroundHistogram(std::vector<cv::Mat> & imgChannels, cv::Mat weights, bool useMatWeights, int x1, int y1, int x2, int y2, int cutoff)
{
    ...
    double sum = 0;
    int cutoffId = std::ceil(rangePerBinInverse*cutoff);
